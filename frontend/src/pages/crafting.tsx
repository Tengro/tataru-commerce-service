...
import type { CraftingResult } from "@/types/api"

const columns: ColumnDef<CraftingResult, unknown>[] = [
  {
    accessorKey: "name",
...
export function CraftingPage() {
  const { data, isLoading } = useScanResults<CraftingResult>("crafting")
  const [filter, setFilter] = useState("")

  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-bold">Crafting Scanner</h2>
